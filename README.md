# system-info-for-geoevent

ArcGIS GeoEvent Server Sample System Info Inbound transports for sending the system information.

![App](systeminfo-for-geoevent.png?raw=true)

## Features
* systeminfo Inbound Transport
